...
public class Redeem {
	...
	static String stringtable = "abcdefghijkmnpqrstuvwxyz234xiaoguo56789";
	public final static String password = "dak3le32233232322";
	...
	public static void main(String[] args) throws Exception {
		ShowTime();
		System.out.println("=======================");
		System.out.println(create((byte) 1, 1, 12, password));;

		System.out.println(VerifyCode("usf2bcpdu2ua"));;
	...
	public static Boolean VerifyCode(String code) {
		...
		if (verify == fullbytes[fullbytes.length - 1]) {
			...
			//return code + " : verify success!";
			return true;
		} else {
			System.out.println(code + " : verify failed!");
			//return code + " : verify failed!";
			return false;
		}
