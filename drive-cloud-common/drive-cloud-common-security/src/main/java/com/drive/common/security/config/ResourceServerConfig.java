...
import com.drive.common.security.component.PermitProps;
import com.drive.common.security.handle.RestAccessDeniedHandler;
import com.drive.common.security.handle.RestAuthenticationEntryPoint;
...
public class ResourceServerConfig extends ResourceServerConfigurerAdapter {
    ...
    @Primary
    @Bean
    public RestTemplate restUrlTemplate() {
        HttpComponentsClientHttpRequestFactory httpRequestFactory = new HttpComponentsClientHttpRequestFactory();
        httpRequestFactory.setConnectTimeout(10000);
        httpRequestFactory.setReadTimeout(10000);
