...
public class ValidateCodeFilter extends AbstractGatewayFilterFactory<Object> {
    ...
    public GatewayFilter apply(Object config) {
        return (exchange, chain) -> {
            ...
            if (StringUtils.containsIgnoreCase(request.getURI().getPath(), AUTH_URL) && ( StringUtils.containsIgnoreCase(grantType, REFRESH_TOKEN)) ||  StringUtils.containsIgnoreCase(grantType, CLIENT_CREDENTIALS)) {
                return chain.filter(exchange);
            }
