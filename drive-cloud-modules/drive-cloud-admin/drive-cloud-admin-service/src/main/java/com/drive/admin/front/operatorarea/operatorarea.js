...
export function listPageOperatorArea(query) {
  return request({
    url: '/admin/operatorArea/pageList',
    method: 'post',
    data: query
  })
}
...
export function listOperatorArea(query) {
  return request({
    url: '/admin/operatorArea/findList',
    method: 'post',
    data: query
  })
}
...
export function changeStatus(data) {
  return request({
    url: '/admin/operatorArea/changeStatus',
    method: 'post',
    data: data
  })
}
...
export function exportOperatorArea(query) {
  return request({
    url: '/admin/operatorArea/exportXls',
    method: 'post',
    params: query,
    responseType: 'blob'
  })
