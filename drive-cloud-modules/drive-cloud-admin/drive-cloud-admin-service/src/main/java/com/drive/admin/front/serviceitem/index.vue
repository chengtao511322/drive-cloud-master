        ...
        <el-row :gutter="10" class="mb8">
            <el-col :span="1.5">
                <el-button
                        ...
                        size="mini"
                        @click="handleAdd"
                        v-hasPermi="['admin:serviceItem:add']"
                >新增</el-button>
            </el-col>
            <el-col :span="1.5">
                <el-button
                        ...
                        :disabled="single"
                        @click="handleUpdate"
                        v-hasPermi="['admin:serviceItem:edit']"
                >修改</el-button>
            </el-col>
            <el-col :span="1.5">
                <el-button
                        ...
                        :disabled="multiple"
                        @click="handleDelete"
                        v-hasPermi="['admin:serviceItem:delete']"
                >删除</el-button>
            </el-col>
            <el-col :span="1.5">
                <el-button
                        ...
                        size="mini"
                        @click="handleExport"
                        v-hasPermi="['admin:serviceItem:export']"
                >导出</el-button>
            </el-col>
        </el-row>
...
<script>
    import { listServiceItem, getServiceItem, delServiceItem, addServiceItem, updateServiceItem, exportServiceItem } from "@/api/admin/serviceItem";
        ...
        methods: {
            ...
            getList() {
                ...
                listServiceItem(this.queryParams).then(response => {
                    this.serviceItemList = response.data.records;
            ...
            handleExport() {
                ...
                this.$confirm('是否确认导出所有服务项目表数据项?', "警告", {
                    confirmButtonText: "确定",
                    cancelButtonText: "取消",
                    type: "warning"
                }).then(function() {
                    return exportServiceItem(queryParams);
                }).then(data => {
                    this.download(data, "服务项目表");
                }).catch(function() {});
            }
        }
    };
