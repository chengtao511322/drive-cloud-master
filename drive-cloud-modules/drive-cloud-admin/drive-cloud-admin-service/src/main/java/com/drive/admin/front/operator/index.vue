<template>
    <div class="app-container">
        <el-form :model="queryParams" ref="queryForm" :inline="true" label-width="68px">
                        ...
                        <el-input
                                v-model="queryParams.channelBeanId"
                                placeholder="请输入其他benaid"
                                clearable
                                size="small"
                                @keyup.enter.native="handleQuery"
                        />
        ...
        <el-row :gutter="10" class="mb8">
            ...
            <el-col :span="1.5">
                <el-button
                    ...
                    :disabled="single"
                    @click="handleUpdate"
                    v-hasPermi="['admin:operator:edit']"
                >修改</el-button>
            </el-col>
            <el-col :span="1.5">
                <el-button
                    ...
                    :disabled="multiple"
                    @click="handleDelete"
                    v-hasPermi="['admin:operator:delete']"
                >删除</el-button>
            </el-col>
            <el-col :span="1.5">
                <el-button
                    ...
                    size="mini"
                    @click="handleExport"
                    v-hasPermi="['admin:operator:export']"
                >导出</el-button>
            </el-col>
        </el-row>
        ...
        >
            <el-table-column type="selection" width="55" align="center" />
                                                ...
                                                <el-table-column label="主键" align="center" prop="id" sortable="custom"/>
                                                                <el-table-column label="运营商名称" align="center" prop="name" sortable="custom"/>
                                                                <el-table-column label="运营商级别(1-省，2-市，3-区(县))" align="center" prop="level" sortable="custom"/>
                                                                <el-table-column label="平台提成百分比" align="center" prop="platformChargePercent" sortable="custom"/>
                        ...
                        <template slot-scope="scope">
                            <span>{{ parseTime(scope.row.updateTime) }}</span>
                                                                ...
                                                                <el-table-column label="使用状态（1：正常；2：停用）" align="center" prop="status" sortable="custom"/>
                                                                <el-table-column label="父级代理商id" align="center" prop="parentId" sortable="custom"/>
                                                                <el-table-column label="分配课时绩效比例" align="center" prop="hourPerformanceRatio" sortable="custom"/>
                                                                <el-table-column label="其他benaid" align="center" prop="channelBeanId" sortable="custom"/>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            getListPage() {
                this.loading = true;
                listPageOperator(this.queryParams).then(response => {
                    this.operatorList = response.data.records;
            ...
            handleExport() {
                ...
                this.$confirm('是否确认导出所有运营商基础信息数据项?', "警告", {
                    confirmButtonText: "确定",
                    cancelButtonText: "取消",
                    type: "warning"
                }).then(function() {
                    return exportOperator(queryParams);
                }).then(data => {
                    this.download(data, "运营商基础信息");
                }).catch(function() {});
            }
        }
    };
