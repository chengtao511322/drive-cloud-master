        ...
        <el-row :gutter="10" class="mb8">
            <el-col :span="1.5">
                <el-button
                    ...
                    size="mini"
                    @click="handleAdd"
                    v-hasPermi="['admin:operatorArea:add']"
                >新增</el-button>
            </el-col>
            <el-col :span="1.5">
                <el-button
                    ...
                    :disabled="single"
                    @click="handleUpdate"
                    v-hasPermi="['admin:operatorArea:edit']"
                >修改</el-button>
            </el-col>
            <el-col :span="1.5">
                <el-button
                    ...
                    :disabled="multiple"
                    @click="handleDelete"
                    v-hasPermi="['admin:operatorArea:delete']"
                >删除</el-button>
            </el-col>
            <el-col :span="1.5">
                <el-button
                    ...
                    size="mini"
                    @click="handleExport"
                    v-hasPermi="['admin:operatorArea:export']"
                >导出</el-button>
            </el-col>
        </el-row>
...
<script>
    import { listOperatorArea,listPageOperatorArea, getOperatorArea, delOperatorArea, addOperatorArea, updateOperatorArea, exportOperatorArea } from "@/api/admin/operatorArea";
