...
public class GeneratorMain {
    ...
    private static String baseProjectPath = "E:\\Project\\gitWork\\drive-cloud-master\\drive-cloud-modules\\drive-cloud-basics\\drive-cloud-basics-service\\";
    private static String baseProjectApiPath = "E:\\Project\\gitWork\\drive-cloud-master\\drive-cloud-modules\\drive-cloud-basics\\drive-cloud-basics-api\\";
    ...
    private static InjectionConfig getInjectionConfig() {
        ...
        InjectionConfig injectionConfig = new InjectionConfig() {
            ...
            public void initMap() {
                ...
                String basePack = "com.drive.common.core.base.";
    ...
    private static List<FileOutConfig> getBackendFile() {
        ...
        backendFileMap.put("Repository.java",       "/%s/repository");
        backendFileMap.put("RepositoryImpl.java",   "/%s/repository/impl");
